...
var Paginator = React8.memo(React8.forwardRef(function(inProps, ref) {
  ...
  var createElement9 = function createElement10(key, template) {
    var element;
    switch (key) {
      case "FirstPageLink":
    ...
    if (template) {
      if (_typeof2(template) === "object") {
        return template.layout ? template.layout.split(" ").map(function(value) {
          var key = value.trim();
          return createElement9(key, template[key]);
        }) : Object.entries(template).map(function(_ref) {
          var _ref2 = _slicedToArray2(_ref, 2), key = _ref2[0], _template = _ref2[1];
          return createElement9(key, _template);
        });
      }
      return template.split(" ").map(function(value) {
        return createElement9(value.trim());
      });
    }
    return null;
  };
...
//# sourceMappingURL=chunk-OQNU4BE4.js.map
